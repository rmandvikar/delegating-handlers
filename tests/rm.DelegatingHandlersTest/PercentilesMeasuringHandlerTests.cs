...
namespace rm.DelegatingHandlersTest
{
	...
	public class PercentilesMeasuringHandlerTests
	{
		...
		public async Task Measures_Percentiles()
		{
			...
			Action<int, double, double, double, double, double, double> processPercentiles = (N, p50, p90, p95, p99, p999, p9999) =>
			{
				processedCount++;
				Console.WriteLine($"[{DateTime.Now.TimeOfDay.ToString(@"hh\:mm\:ss\.fff")}] N: {N,10}, p50: {p50,10:F3}, p90: {p90,10:F3}, p95: {p95,10:F3}, p99: {p99,10:F3}, p999: {p999,10:F3}, p9999: {p9999,10:F3}");
			};
			...
			percentilesMeasuringProcessorMock
				.Setup(x => x.Process(It.IsAny<int>(), It.IsAny<double>(), It.IsAny<double>(), It.IsAny<double>(), It.IsAny<double>(), It.IsAny<double>(), It.IsAny<double>()))
