...
namespace rm.DelegatingHandlersTest
{
	...
	public class PercentilesMeasuringHandlerTests
	{
		...
		public async Task Verify()
		{
			...
			var percentilesMeasuringHandler =
				new PercentilesMeasuringHandler(
					new PercentilesMeasuringHandlerSettings
					{
						...
						OnProcessingError = (ex) => Console.WriteLine(ex),
					});
			...
			percentilesMeasuringProcessorMock.Verify(x =>
				x.Process(It.IsAny<string>(), It.IsAny<int>(), It.IsAny<double>(), It.IsAny<double>(), It.IsAny<double>(), It.IsAny<double>(), It.IsAny<double>(), It.IsAny<double>(), It.IsAny<double>(), It.IsAny<double>()),
				Times.Once);
		}
